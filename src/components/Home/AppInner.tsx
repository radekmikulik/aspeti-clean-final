// ASPETi PLUS - Opravená verze 2024
...
export default function AppInner() {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f9fafb' }}>
      <header style={{ backgroundColor: 'white', padding: '16px 20px', borderBottom: '1px solid #e5e7eb' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <nav style={{ display: 'flex', alignItems: 'center', gap: '32px' }}>
            <a href="/" style={{ color: '#374151', textDecoration: 'none', fontWeight: '500' }}>Nabídky</a>
            <a href="/providers" style={{ color: '#374151', textDecoration: 'none', fontWeight: '500' }}>Poskytovatelé</a>
            <a href="/about" style={{ color: '#374151', textDecoration: 'none', fontWeight: '500' }}>O projektu</a>
          </nav>
          
          {/* Auth tlačítka */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <button onClick={() => console.log('Přihlásit clicked')} style={{ 
            ...
            <button onClick={() => console.log('Registrovat clicked')} style={{ 
            ...
            <button onClick={() => router.push('/account/profile/edit')} style={{ 
